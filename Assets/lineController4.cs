...
public class lineController4 : MonoBehaviour {
	...
	private Vector3 v0 = new Vector3(50.0f,0.0f,0.0f);
	private Vector3 v1 = new Vector3(0.0f,0.0f,0.0f);
	//private Vector3 v2 = new Vector3(50.0f,0.0f,0.0f);
	...
	void Update() {
		...
		v0 = new Vector3 (world.x , 0.0f, world.z - 200.0f);
		v1 = new Vector3 (world.x , 0.0f, world.z - 2.0f);
